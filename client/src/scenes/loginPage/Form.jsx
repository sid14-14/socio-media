      ...
      {({
        ...
        <form onSubmit={handleSubmit}>
          <Box
            ...
            //we splitting our grid into four sections, min it gonna be zero else equal fractions of 4
            sx={{
            ...
            {isRegister && ( //if its on register page we have number of components here
              <>
                ...
                <TextField //input component for material ui
                  ...
                  name="occupation"
                  error={
                    Boolean(touched.occupation) && Boolean(errors.occupation) //checking if it hasnt been touched or is there an error, then it show we have an error
                  }
