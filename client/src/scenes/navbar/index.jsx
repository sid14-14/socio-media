...
const Navbar = () => {
  ...
  return (
    <FlexBetween padding="1rem 6%" backgroundColor={alt}> {/* reusable component which has all the prop we defined already, it also has box component, which allows us to pass any type of css property and use them as component property */}
