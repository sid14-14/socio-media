...
app.post("/posts", verifyToken, upload.single("picture"), createPost); //when we send from the front-end the pic, this prop grabs the pic: "upload.single("picture")", here is where image located in http call, it will grab and upload it
...
mongoose
  .connect(process.env.MONGO_URL, { //connecting to actual db from node server
